...
export default function Chapter({isActive, chapter_id, title, hadis_range, setActiveChapter}){

    return(
        <button className={`chapter text-left dark:text-light3 group p-3 mx-3 rounded-lg flex items-center gap-3 transition ${isActive?"bg-accent1 dark:bg-dark1":"bg-light1 dark:bg-dark3 hover:bg-accent1 dark:hover:bg-dark1"}`} onClick={()=>{setActiveChapter(chapter_id);console.log("Active Chapter: ",chapter_id)}}>
